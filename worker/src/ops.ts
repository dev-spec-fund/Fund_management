...
export async function ensureOperationalSchema(env: Env) {
  ...
  try {
    ...
    const checks:[string,string[]][] = [
      ...
      ["elections", ["title","term","opens_at","closes_at","status","created_by","certified_at","certified_by","applications_open_at","applications_close_at","applications_notified_at","applications_reminder_at"]],
      ["election_positions", ["election_id","title","seats","max_selections","min_selections","sort_order"]],
